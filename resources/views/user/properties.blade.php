...
.property-card img {
    border-radius: 10px;
    width: 100%;
    height: 130px;  /* Adjusted height for the smaller card */
    object-fit: cover;
}
...
.btn-primary {
    ...
    color: white;
    padding: 6px 16px; /* Adjusted button padding */
    font-size: 12px; /* Smaller font size for the button */
}

/* Flex container for responsive circular layout */
...
<body>
    ...
    <div class="container py-5">
        <h1 class="text-center font-weight-bold">Our Properties</h1>
        ...
        <div id="propertyCards" class="row property-card-wrapper">
                ...
                success: function(response) {
                    ...
                    if (response.properties && response.properties.length > 0) {
                        response.properties.forEach(function(property) {
                            const card = `
                                <div class="col-md-3 property-card">
                                    <div class="card">
